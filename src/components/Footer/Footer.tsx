        ...
        <div className={s.footerStyle}>
            <div className={s.footerBlock}>
                ...
                <div className={s.footersIMG}>
                    <a href='https://t.me/kitiflat' target="_blank"> <img src={telegram} className={s.imgFoot} /></a>
                    <a href='https://www.linkedin.com/in/alexandr-kot-0a5b9a262/' target="_blank"><img src={linked} className={s.imgFoot} /></a>
                    <a href='mailto:alexandr.kot.dev@gmail.com?subject=Job notification letter'><img src={gmail} className={s.imgFoot} /></a>
                    <a href='https://github.com/Kot-Alexandr' target="_blank"> <img src={github} className={s.imgFoot} /></a>
                    <a href='https://www.instagram.com/kotofojo/' target="_blank"> <img src={inst} className={s.imgFoot} /></a>
                </div>
